...
$CXX -O2 -fno-inline -I. \
     ...
     -lunilog \
     -lpthread \
     -I=/ml/scratch/seungjoy/cnpy/lib/include \
     -L=/ml/scratch/seungjoy/cnpy/lib/lib/ \
     -Wl,-rpath=/ml/scratch/seungjoy/cnpy/lib/lib \
     /ml/scratch/seungjoy/cnpy/lib/lib/libcnpy.so
